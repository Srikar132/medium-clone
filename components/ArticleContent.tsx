...
const ArticleContent = async ({ id }: { id: string }) => {
  ...
  return (
    <article className="w-full h-screen overflow-y-auto pb-20 lg:p-5 pointer-events-auto space-y-4 mt-3 relative  ">
      <header className="w-full space-y-2">
        <div className="flex items-center gap-2">
          <span className="text-xl whitespace-pre-wrap max-w-1/2 font-bold tracking-wider">
            {post?.title}
          </span>
        </div>
        ...
        <div
          id="article-header"
          className="sticky top-0 z-50 backdrop-blur-md py-3 flex items-center gap-2 justify-between bg-white dark:bg-transparent"
        >
          <div className="flex items-center gap-2">
