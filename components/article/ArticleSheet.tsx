...
const ArticleSheet = ({ content, id }: { content: ReactNode; id: string }) => {
  const router = useRouter();
  const {openComments} = useCommentStore();
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="hidden lg:flex flex-col gap-3 p-3 sticky top-1/4 mr-4 self-start">
          <ToogleCommentsBtn/>
          {!openComments && (
