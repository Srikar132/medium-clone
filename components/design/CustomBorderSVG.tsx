...
export const  PinkContainer = () => {
  return (
    <div className="relative  max-w-xl h-[20rem] py-8 px-3 ">
    ...
    <div className="relative flex flex-col  py-7 px-4">
      ...
      <div className="grid grid-cols-2 gap-5 mt-7">
        <p className="mt-4text-sm  md:text-lg text-black">
          Agency that builds many amazing products to boost your business to the next level.
          Lorem ipsum dolor .
        </p>
    ...
    <div className="absolute max-sm:top-10 top-7 right-0 lg:right-5 bg-white w-10 h-10 lg:w-14 lg:h-14 flex items-center justify-center rounded-full shadow-md border border-gray-200">
