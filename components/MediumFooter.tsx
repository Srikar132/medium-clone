      ...
      <div className="w-full mx-auto screen-max-width-1700 sm:px-10 px-5">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="flex space-x-6">
            <a href="https://twitter.com/infraink" aria-label="Twitter" className="">
              <FaTwitter size={20} />
            </a>
            <a href="https://facebook.com/infraink" aria-label="Facebook" className="">
              <FaFacebook size={20} />
            </a>
            <a href="https://instagram.com/infraink" aria-label="Instagram" className="">
              <FaInstagram size={20} />
            </a>
          </div>
        </div>
        ...
        <div className="mt-16 flex flex-wrap justify-between">
          <div className="mb-4 md:mb-0">
            <span className="text-gray-500">© 2025 InfraInk</span>
