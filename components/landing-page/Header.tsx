  ...
  return (
    <header className="w-full">
      <div className="nav pt-5">
        ...
        <nav
          className={`${openNavigation ? "flex" : "hidden"} fixed top-0 left-0 right-0 
        ...
        >
          ...
          >
            <FontAwesomeIcon
              icon={faClose}
              className="text-2xl text-white m-1 cursor-pointer"
            />
          </button>
        </nav>
        ...
        <div className="bg-gradient-to-r hidden lg:block from-custom-baby-pink via-custom-pink  to-custom-sky-blue ml-10 max-lg:ml-auto pt-1 rounded-full">
          <Link
            href={"/login"}
            className="rounded-full px-5 py-3 text-lg capitalize tracking-wider cursor-pointer text-white bg-[#282A38]"
          >
            signup
          </Link>
        </div>
