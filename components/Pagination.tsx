...
export default function Pagination({
  ...
  const handlePageChange = (pageNumber : number) => {
    ...
    // Use router.push with scroll: false to maintain current scroll position
  ...
  return (
    <div className={`flex items-center justify-center gap-2 py-8 ${className}`}>
      <Button
        variant="ghost"
        className="gap-1 px-4 py-2 text-gray-600 transition-colors hover:text-gray-400 disabled:opacity-50"
