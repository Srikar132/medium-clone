...
const BookmarkButton = ({ postId, initialBookmarked }: BookmarkButtonProps) => {
  ...
  const handleBookmark = async () => {
    ...
    try {
      ...
      if (result.OK) {
        ...
        toast(!isBookmarked ? "Bookemarked the article successfully - liked page will update later!." : "Unbookmarked the article successfully - Liked page will update later!.")
      }
    } catch (error: any) {
  ...
  return (
    <TooltipWrapper content=" bookmar " side="bottom" align="center">
      <button
        disabled={isLoading}
