...
export default async function ProfileLayout({
    ...
    return (
        <div className="w-full mx-auto max-w-4xl h-screen p-5 lg:p-10">
          <div className="w-full mb-10 flex items-center justify-between p-2 sm:p-5 md:p-6 lg:p-7">
          <h1 className="text-2xl md:text-4xl lg:text-6xl font-semibold font-cursive">Your Stories</h1>
          ...
          <TabsNav
              tabs={[{name : "drafts" , url : "/my-articles/drafts"},
